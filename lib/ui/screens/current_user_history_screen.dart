...
class CurrentUserHistoryScreen extends StatefulWidget {
  const CurrentUserHistoryScreen({Key? key}) : super(key: key);

  @override
  State<CurrentUserHistoryScreen> createState() => _CurrentUserHistoryScreenState();
}

class _CurrentUserHistoryScreenState extends State<CurrentUserHistoryScreen> {
